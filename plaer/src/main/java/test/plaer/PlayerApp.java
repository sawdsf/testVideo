...
public class PlayerApp {
    ...
    private void openFile(String filename) {
        try {
            ...
            bus.connect((Bus.ERROR) (src, code, msg) -> System.err.println("GStreamer ERROR: " + msg));
            bus.connect((Bus.EOS) src -> System.out.println("GStreamer: End of stream"));
    ...
    private Element createFilterElementByName(String name) {
        try {
            if ("Черно-белый".equals(name)) {
                ...
                JOptionPane.showMessageDialog(frame, "Инверсия недоступна (нет frei0r и videoinvert).");
                return null;
                ...
                JOptionPane.showMessageDialog(frame, "Размытие недоступно (нет frei0r blur).");
                return null;
            } else {
                return null;
            }
